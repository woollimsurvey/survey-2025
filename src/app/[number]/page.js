      ...
      <main>
        <article>
          ...
          <Text className="indent-1">
            한국산업기술기획평가원(KEIT)에서는 산업기술 R&D 투자방향의 전략성을
            확보하고 R&D 재원을 효율적으로 배분하기 위해 격년 주기로
            산업기술수준조사를 실시하고 있습니다.
          </Text>
          <br />
          <Text className="indent-1">
            본 조사는 「2025년 산업기술수준조사」로서, 1~2차 델파이 조사 중 1차
            조사에 해당합니다.
          </Text>
          <br />
          <Text className="indent-1">
            바쁘신 와중에도 조사에 응해주심에 감사의 말씀을 드리오며, 제시된
            문항에 성실히 응답해주신 분들에 한하여 소 정의 기프티콘을 지급해드릴
            예정이오니 적극적인 참여를
            <br />
            부탁드리겠습니다.
          </Text>
